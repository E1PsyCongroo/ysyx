...
#
# Script generated by Vivado on Fri Dec 06 10:00:23 CST 2024
...
#
# Usage        : CLK_WIZ_IP.sh
#                CLK_WIZ_IP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CLK_WIZ_IP.sh [-reset_run]
#                CLK_WIZ_IP.sh [-reset_log]
#                CLK_WIZ_IP.sh [-help]
#
...
#                script (type 'CLK_WIZ_IP.sh -help' for more information).
#
...
# script info
echo -e "CLK_WIZ_IP.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CLK_WIZ_IP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.CLK_WIZ_IP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.CLK_WIZ_IP -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log CLK_WIZ_IP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: CLK_WIZ_IP.sh [-step]\n\
Usage: CLK_WIZ_IP.sh [-lib_map_path]\n\
Usage: CLK_WIZ_IP.sh [-reset_run]\n\
Usage: CLK_WIZ_IP.sh [-reset_log]\n\
Usage: CLK_WIZ_IP.sh [-keep_index]\n\
