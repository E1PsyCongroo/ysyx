...
#
# Script generated by Vivado on Sat Dec 07 23:05:24 CST 2024
...
# script info
echo -e "RAM_IP.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_IP xil_defaultlib.RAM_IP xil_defaultlib.glbl -log elaborate.log
}
