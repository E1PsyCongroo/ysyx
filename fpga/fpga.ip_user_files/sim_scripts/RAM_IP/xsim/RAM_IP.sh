...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_IP xil_defaultlib.RAM_IP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RAM_IP -key {Behavioral:sim_1:Functional:RAM_IP} -tclbatch cmd.tcl -protoinst "protoinst_files/TOP.protoinst" -log simulate.log
}
