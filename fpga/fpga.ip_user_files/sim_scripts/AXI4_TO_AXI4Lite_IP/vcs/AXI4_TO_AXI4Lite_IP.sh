...
design_libs=(xpm generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axi_protocol_converter_v2_1_28 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AXI4_TO_AXI4Lite_IP xil_defaultlib.glbl -o AXI4_TO_AXI4Lite_IP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AXI4_TO_AXI4Lite_IP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key AXI4_TO_AXI4Lite_IP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AXI4_TO_AXI4Lite_IP_simv.daidir vcs_lib c.obj)
