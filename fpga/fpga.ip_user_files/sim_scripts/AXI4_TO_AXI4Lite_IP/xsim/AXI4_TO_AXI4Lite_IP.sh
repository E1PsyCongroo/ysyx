...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L generic_baseblocks_v2_1_0 -L fifo_generator_v13_2_8 -L axi_data_fifo_v2_1_27 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_28 -L axi_protocol_converter_v2_1_28 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AXI4_TO_AXI4Lite_IP xil_defaultlib.AXI4_TO_AXI4Lite_IP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AXI4_TO_AXI4Lite_IP -key {Behavioral:sim_1:Functional:AXI4_TO_AXI4Lite_IP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AXI4_TO_AXI4Lite_IP.wdb xsim.dir libdpi.so)
