...
#
# Script generated by Vivado on Sat Dec 07 20:44:16 CST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : AXI4_TO_AXI4Lite_IP.sh
...
#
# Usage        : AXI4_TO_AXI4Lite_IP.sh
#                AXI4_TO_AXI4Lite_IP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AXI4_TO_AXI4Lite_IP.sh [-reset_run]
#                AXI4_TO_AXI4Lite_IP.sh [-reset_log]
#                AXI4_TO_AXI4Lite_IP.sh [-help]
#
...
#                script (type 'AXI4_TO_AXI4Lite_IP.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname generic_baseblocks_v2_1_0 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_28 -libname axi_protocol_converter_v2_1_28 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "AXI4_TO_AXI4Lite_IP.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AXI4_TO_AXI4Lite_IP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axi_protocol_converter_v2_1_28 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AXI4_TO_AXI4Lite_IP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AXI4_TO_AXI4Lite_IP -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AXI4_TO_AXI4Lite_IP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AXI4_TO_AXI4Lite_IP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AXI4_TO_AXI4Lite_IP.sh [-help]\n\
Usage: AXI4_TO_AXI4Lite_IP.sh [-step]\n\
Usage: AXI4_TO_AXI4Lite_IP.sh [-lib_map_path]\n\
Usage: AXI4_TO_AXI4Lite_IP.sh [-reset_run]\n\
Usage: AXI4_TO_AXI4Lite_IP.sh [-reset_log]\n\
Usage: AXI4_TO_AXI4Lite_IP.sh [-keep_index]\n\
Usage: AXI4_TO_AXI4Lite_IP.sh [-noclean_files]\n\n\
