...
HD_PWD='/home/focused_xy/cs/ysyx/fpga/fpga.runs/TOP_BRAM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_BRAM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_BRAM_0_0.tcl
