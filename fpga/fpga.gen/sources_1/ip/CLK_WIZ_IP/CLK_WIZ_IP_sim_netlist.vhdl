...
-- Date        : Fri Dec  6 10:00:47 2024
-- Host        : FocusedXYArchlinuxLaptop running 64-bit Arch Linux
-- Command     : write_vhdl -force -mode funcsim
--               /home/focused_xy/cs/ysyx/fpga/fpga.gen/sources_1/ip/CLK_WIZ_IP/CLK_WIZ_IP_sim_netlist.vhdl
-- Design      : CLK_WIZ_IP
...
architecture STRUCTURE of CLK_WIZ_IP_clk_wiz is
  ...
  signal clk_out3_CLK_WIZ_IP : STD_LOGIC;
  signal clk_out4_CLK_WIZ_IP : STD_LOGIC;
  signal clk_out5_CLK_WIZ_IP : STD_LOGIC;
...
clkout4_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_out4_CLK_WIZ_IP,
      O => clk_out4
    );
clkout5_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_out5_CLK_WIZ_IP,
      O => clk_out5
    );
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      CLKOUT3 => clk_out4_CLK_WIZ_IP,
      CLKOUT4 => clk_out5_CLK_WIZ_IP,
