...
design_libs=(xpm axi_lite_ipif_v3_0_4 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 lib_cdc_v1_0_2 axi_uartlite_v2_0_32 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AXI_UART_IP xil_defaultlib.glbl -o AXI_UART_IP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AXI_UART_IP_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/focused_xy/cs/ysyx/npc/fpga/fpga.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key AXI_UART_IP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AXI_UART_IP_simv.daidir vcs_lib c.obj)
