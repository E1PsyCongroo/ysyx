...
#
# Script generated by Vivado on Thu Dec 05 15:25:50 CST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : AXI_UART_IP.sh
...
#
# Usage        : AXI_UART_IP.sh
#                AXI_UART_IP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AXI_UART_IP.sh [-reset_run]
#                AXI_UART_IP.sh [-reset_log]
#                AXI_UART_IP.sh [-help]
#
...
#                script (type 'AXI_UART_IP.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_lite_ipif_v3_0_4 -libname lib_pkg_v1_0_2 -libname lib_srl_fifo_v1_0_2 -libname lib_cdc_v1_0_2 -libname axi_uartlite_v2_0_32 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_lite_ipif_v3_0_4 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 lib_cdc_v1_0_2 axi_uartlite_v2_0_32 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "AXI_UART_IP.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AXI_UART_IP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AXI_UART_IP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AXI_UART_IP -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/focused_xy/cs/ysyx/npc/fpga/fpga.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AXI_UART_IP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AXI_UART_IP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AXI_UART_IP.sh [-help]\n\
Usage: AXI_UART_IP.sh [-step]\n\
Usage: AXI_UART_IP.sh [-lib_map_path]\n\
Usage: AXI_UART_IP.sh [-reset_run]\n\
Usage: AXI_UART_IP.sh [-reset_log]\n\
Usage: AXI_UART_IP.sh [-keep_index]\n\
Usage: AXI_UART_IP.sh [-noclean_files]\n\n\
