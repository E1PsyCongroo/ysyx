...
module Uart(	// @[src/main/scala/npc/dev/Uart.scala:8:7]
  ...
  wire        writeValid = writeMask == 4'h1;	// @[src/main/scala/npc/dev/Uart.scala:59:28, :63:31]
  wire        _bresp_T_2 = bvalid & writeValid;	// @[src/main/scala/npc/dev/Uart.scala:28:27, :63:31, :68:16]
  ...
  assign io_bresp = _bresp_T_2 ? 2'h0 : {2{bvalid & ~writeValid}};	// @[src/main/scala/chisel3/util/Mux.scala:126:16, src/main/scala/npc/dev/Uart.scala:8:7, :28:27, :63:31, :68:16, :69:{16,19}]
