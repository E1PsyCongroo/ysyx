...
object Instruction {
  ...
  object InstructionMap {
    ...
    val MUL    = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b000"), funct7 = BitPat("b0000001"))
    val MULH   = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b001"), funct7 = BitPat("b0000001"))
    val MULHSU = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b010"), funct7 = BitPat("b0000001"))
    val MULHU  = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b011"), funct7 = BitPat("b0000001"))
    val DIV    = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b100"), funct7 = BitPat("b0000001"))
    val DIVU   = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b101"), funct7 = BitPat("b0000001"))
    val REM    = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b110"), funct7 = BitPat("b0000001"))
    val REMU   = Instruction(opcode = BitPat("b0110011"), funct3 = BitPat("b111"), funct7 = BitPat("b0000001"))

    val MRET = Instruction(
      opcode = BitPat("b1110011"),
      funct3 = BitPat("b000"),
      funct7 = BitPat("b0011000"),
      rs1    = BitPat("b00000"),
      rs2    = BitPat("b00010"),
      rd     = BitPat("b00000")
    )
